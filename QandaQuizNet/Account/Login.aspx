<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="QandaQuizNet.Account.Login" Async="true" %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <div class="checkbox OverrrideBootStrapLeftMarginForCheckBox">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <asp:Button runat="server" OnClick="LogIn" Text="Log in" CssClass="btn btn-default btn-danger" />
                        </div>
                    </div>
                </div>

                <div class="col-md-offset-2 col-md-10 OverrideBootStrapLeftPadding">
                    <div class="row">
                        <div class="col-md-4 OverrideBootStrapLeftPadding">
                            <asp:HyperLink runat="server" ID="RegisterHyperLink" ViewStateMode="Disabled">Register as a new user</asp:HyperLink>
                        </div>
                        <div class="col-md-6 OverrideBootStrapLeftPadding ">
